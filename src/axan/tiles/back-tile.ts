...
export default class BackTile extends Tile {
  ...
  wallIndex() {
    ...
    const NESWmappings: Array<{ map: Array<string | null>; t: Array<number> }> = [
      ...
      {
        map: ["None", "BackTile", "None|BackTile", "BackTile"],
        t: TILES.LEDGE_M,
      },
      ...
      {
        map: ["BackTile|", "BackTile|", "BackTile|", "BackTile|"],
        t: TILES.ENCLOSED,
      },
    ];
    ...
    const fullMappings: Array<{ map: Array<string | null>; t: Array<number> }> = [
      ...
      {
        map: ["None", "BackTile|Door|None", "BackTile|Door", "BackTile|", "BackTile|", "BackTile|", "BackTile|Door", "BackTile|Door|None"],
        t: TILES.FLOOR,
      },
      {
        map: ["BackTile|", "BackTile|", "BackTile|Door", "BackTile|Door|None", "None", "BackTile|Door|None", "BackTile|Door", "BackTile|"],
        t: TILES.CEILING,
      },
      {
        map: ["BackTile|Door", "BackTile|Door|None", "None", "BackTile|Door|None", "BackTile|Door", "BackTile|", "BackTile|", "BackTile|"],
        t: TILES.LEFT,
      },
      {
        map: ["BackTile|Door", "BackTile|", "BackTile|", "BackTile|", "BackTile|Door", "BackTile|Door|None", "None", "BackTile|Door|None"],
        t: TILES.RIGHT,
      },
      {
        map: ["BackTile|", "BackTile|", "BackTile|Door", "None", "BackTile|Door", "BackTile|", "BackTile|", "BackTile|"],
        t: TILES.TL_INNER,
      },
      {
        map: ["BackTile|", "BackTile|", "BackTile|", "BackTile|", "BackTile|Door", "None", "BackTile|Door", "BackTile|"],
        t: TILES.TR_INNER,
      },
      {
        map: ["BackTile|Door", "None", "BackTile|Door", "BackTile|", "BackTile|", "BackTile|", "BackTile|", "BackTile|"],
        t: TILES.BL_INNER,
      },
      {
        map: ["BackTile|Door", "BackTile|", "BackTile|", "BackTile|", "BackTile|", "BackTile|", "BackTile|Door", "None"],
        t: TILES.BR_INNER,
      },
